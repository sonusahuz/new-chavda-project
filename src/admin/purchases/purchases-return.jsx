    ...
    <div className="p-6">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div className="flex items-center justify-between  gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">Return Order</h3>
            ...
            <div className="flex items-center justify-between  gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">Pending Return Order</h3>
            ...
            <div className="flex items-center justify-between  gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">Total Customer</h3>
            ...
            <div className="flex items-center justify-between  gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">Return Order Received</h3>
      ...
      <div className="my-6 border shadow-2xl rounded-2xl p-6">
        <div className="flex justify-between items-center mb-3">
          <h1 className="text-lg text-gray-600 font-bold">All Order Items</h1>
...
export default AdminPurchasesReturn;
