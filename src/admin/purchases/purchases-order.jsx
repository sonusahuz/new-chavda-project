          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div className="flex items-center justify-between  gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">Total Orders</h3>
            ...
            <div className="flex items-center justify-between  gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">Order Items Over Time</h3>
...
export default AdminPurchasesOrder;
