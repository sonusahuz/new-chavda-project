          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div className="flex items-center justify-between gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">Total Product Items</h3>
                <p className="text-sm text-muted-foreground">3521 (Items)</p>
              </div>
            ...
            <div className="flex items-center justify-between gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">In Stock Product</h3>
                <p className="text-sm text-muted-foreground">1311 (Items)</p>
              </div>
              <div className="p-3 rounded-lg bg-orange-100">
            ...
            <div className="flex items-center justify-between gap-4 shadow-2xl p-4">
              <div className="space-y-1">
                <h3 className="text-base font-medium">Out Of Stock Product</h3>
                <p className="text-sm text-muted-foreground">231 (Items)</p>
              </div>
              <div className="p-3 rounded-lg bg-orange-100">
          ...
          <table className="min-w-full border-collapse text-sm text-left">
            <thead>
              <tr className="bg-gray-100 border-b">
                ...
                <th className="px-3 py-3 text-left">Warehouse ID</th>
                <th className="px-3 py-3">Warehouse Name</th>
                <th className="px-3 py-3">Location</th>
                <th className="px-3 py-3">Manager</th>
                <th className="px-3 py-3">Contact Number</th>
                <th className="px-3 py-3">Stock Available</th>
                <th className="px-3 py-3">Stock Shipping</th>
                <th className="px-3 py-3">Warehouse Revenue</th>
